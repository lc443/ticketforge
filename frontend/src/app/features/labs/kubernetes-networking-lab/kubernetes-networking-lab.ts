...
@Component({
  selector: 'app-kubernetes-networking-lab', standalone: true,
  imports: [LabBreadcrumb, ScenarioCard],
  templateUrl: './kubernetes-networking-lab.html',
  styleUrl: './kubernetes-networking-lab.scss',
})
export class KubernetesNetworkingLab {
